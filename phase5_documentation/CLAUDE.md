...
> Read `methodology/04-output.md` for the full AN specification.
> Read `methodology/02-phases.md` → "Phase 5" for phase requirements.
> Read `methodology/04-output.md` for figure standards.
> Read `methodology/03-review.md` for the review checklist.
...
decision, not a typesetting decision. See `methodology/02-phases.md` →
...
- AN specification: `methodology/04-output.md`
- Review protocol: `methodology/03-review.md` → §6.2 (5-bot), §6.4
- Plotting / captions: `methodology/04-output.md`
- Checklist: `methodology/03-review.md`
...
See `methodology/04-output.md` for the full AN specification including
...
**5-bot review** — see `methodology/03-review.md` for protocol.
