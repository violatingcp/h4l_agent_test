...
> Read `methodology/02-phases.md` → "Phase 2" for full requirements.
...
- Phase requirements: `methodology/02-phases.md` → Phase 2
...
`methodology/02-phases.md` → Phase 2 "Data discovery" for the protocol
...
`methodology/02-phases.md` → Phase 2 for full details.
