...
> Read `methodology/02-phases.md` → "Phase 3" for full requirements.
...
- Phase requirements: `methodology/02-phases.md` → Phase 3
- Technique-specific requirements: `methodology/02-phases.md` → Phase 3 "Correction infrastructure" / "Background estimation" subsections
- Review protocol: `methodology/03-review.md` → §6.2 (1-bot), §6.4
...
See `methodology/02-phases.md` → Phase 3 "Selection" for full requirements.
...
choice (see `methodology/05-practices.md`).
...
See `methodology/02-phases.md` → Phase 3 for full details.

## Closure test alarm bands (mandatory)

These apply to Phase 3 AND Phase 4a — read `methodology/02-phases.md`
...
**1-bot review** — see `methodology/03-review.md` for protocol.
Write findings to `review/{role}/` using session-named files
(see `methodology/06-appendix.md` for naming conventions).
