...
> Read `methodology/02-phases.md` → "Phase 1" for full requirements.
...
- Phase requirements: `methodology/02-phases.md` → Phase 1
- Review protocol: `methodology/03-review.md` → §6.2 (4-bot), §6.4
...
`methodology/02-phases.md` → Phase 1 for full details.
...
- **≥2 selection approaches must be qualitatively different.** Two
  ...
  selection as a downscope from MVA (see `methodology/05-practices.md`),
...
**4-bot review** — see `methodology/03-review.md` for protocol.
